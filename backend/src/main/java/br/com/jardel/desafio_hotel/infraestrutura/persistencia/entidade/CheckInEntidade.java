...
public class CheckInEntidade {
    ...
    protected CheckInEntidade() { }

    public CheckInEntidade(Long id, Long idHospede, LocalDateTime dataEntrada, LocalDateTime dataSaida, boolean adicionalVeiculo) {
        this.id = id;
